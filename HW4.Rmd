...
calculate z score by hand; use pt function to get the p-value

# Blinding

Summary of Anand et al.:
...
Both are greater than or equal to 5, and so the approximation is valid.  The p-value for the above z-statistic can be computed with the `prop.test` function:
